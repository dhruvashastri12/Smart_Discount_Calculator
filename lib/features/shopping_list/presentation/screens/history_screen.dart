...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget _buildAllTimeSummaryCard(bool isDark) {
    return Container(
      margin: const EdgeInsets.fromLTRB(AppDimensions.paddingL, AppDimensions.paddingL, AppDimensions.paddingL, AppDimensions.paddingS),
              ...
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        DateFormat(AppStrings.formatMonthYear).format(monthDate),
                        style: TextStyle(fontFamily: 'DMSans', 
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(AppStrings.historyEmptyMsg, style: TextStyle(fontFamily: 'DMSans', fontSize: AppDimensions.fontS + 1, color: AppColors.neutralText)),
        ],
      ),
    );
  }
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          DateFormat(AppStrings.formatFullDayDate).format(date).toUpperCase(), 
                          style: TextStyle(fontFamily: 'DMSans', 
                  ...
                  Column(
                    ...
                    children: [
                      if (daySavings > 0)
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: AppDimensions.paddingM, vertical: 4),
                          decoration: BoxDecoration(
